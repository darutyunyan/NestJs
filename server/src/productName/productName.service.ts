...
import { ProductType, ProductTypeDocument } from "src/productType/schemas/productType.schema";
import { CreateProductNameDto } from "./dto/create-product-name.dto";
import { ProductName, ProductNameDocument } from "./schemas/productName.schema";
